...
* [Go开发笔记](https://leanpub.com/GoNotebook/read)
* [Go编程介绍](https://www.golang-book.com/)
* [用Go构建Web应用程序](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
* [用Go构建Web应用程序](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
* [爱上Go](https://bitfieldconsulting.com/books/love) - An introductory book for Go beginners.
* [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
* [Go 训练营](http://golangbootcamp.com)
* [Go 简洁编程](https://github.com/thedevsir/gosuccinctly) - in Persian.
* [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.
* [开始使用Go](https://www.digitalocean.com/community/books/how-to-code-in-go-ebook) - A 600 page introduction to Go aimed at first time developers.
* [学习Go](https://www.miek.nl/downloads/Go/Learning-Go-latest.pdf)
* [Go网络编程](https://jan.newmarch.name/go/)
* [Go练习课](https://www.practical-go-lessons.com/)
* [Go标准库案例](https://blasrodri.github.io/spaceship-go-gh-pages/)
* [Go语言编程](https://www.gopl.io/)
* [Go标准库案例(中文)](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example)
* [Go Web编程](https://github.com/thewhitetulip/web-dev-golang-anti-textbook/)
* [用Go实现编译器](https://compilerbook.com)
* [用Go实现一个拦截器](https://interpreterbook.com)
