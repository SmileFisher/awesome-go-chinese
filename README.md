...
本仓来自公共资源，主要内容是[avelino/awesome-go](https://github.com/avelino/awesome-go)的翻译
，并做了精简和修改。
...
* [flac](https://github.com/mewkiz/flac) - Go原生 FLAC 编码器/解码器，支持 FLAC 流。
* [gaad](https://github.com/Comcast/gaad) - Go原生 AAC 比特流解析器。
* [GoAudio](https://github.com/DylanMeeus/GoAudio) -  Go原生音频处理库。
* [gosamplerate](https://github.com/dh1tw/gosamplerate) - Go采样率绑定。
...
* [mix](https://github.com/go-mix/mix) - 用于音乐应用的基于序列的 Go-native 音频混合器。
...
* [PortAudio](https://github.com/gordonklaus/portaudio) - PortAudio 音频 I/O 库的绑定Go。
